	...
	<div class="wrapper" style="padding-top: 60px;">
								...
								<div class="ttl121">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page" style="color:white;">TERM OF USE</li>
										</ol>
									</nav>
								</div>
							</div>
		...
		<div class="sa4d25">
			<div class="container-fluid" style="background-color:white;" width="100%" height="100%">
				<center>
					<h2 style="margin-top:50px;font-weight:bold">TERM OF USE</h2>
					<center>
						<center>
							<p>By signing up on the Eklvya IAS Academy Website you are agreeing to be bound by the following terms and conditions (“Terms of Use”).</p>
						</center>
