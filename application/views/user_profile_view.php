				...
				<div class="row justify-content-md-center">
					<div class="col-md-10">
						<div class="section3125 rpt145">							
							<div class="row">						
								<div class="col-lg-7">
									<!-- <a href="<?php echo site_url('My/setting'); ?> class="_216b22">										
...
?>
									<div class="dp_dt150">						
										...
										<div class="prfledt1">
											<h2><?php echo $log_customer[0]->kh_user_fname; ?></h2>
											 <span>Phone : <?php echo $log_customer[0]->kh_user_contact; ?></span>
											<!--  <br>
											  <span>Alt Phone : <?php echo $log_customer[0]->kh_user_alt_contact; ?></span>
											 <br>
											 <span>Email : <?php echo $log_customer[0]->kh_user_email; ?></span>
											  <br>
											 <span>DOB : <?php echo $log_customer[0]->kh_user_dob; ?></span>
											   <br>
											 <span>Address : <?php echo $log_customer[0]->kh_user_address; ?></span> -->
										</div>										
									</div>
									
								</div>
								<div class="col-lg-5">
									<!-- <a href="<?php echo site_url('My/setting'); ?>" class="_216b12">										
										<span><i class="uil uil-cog"></i></span>Setting
									</a> -->
									<div class="rgt-145 ">
									...
									<ul class="_bty149">								
										<li><button class="msg125 btn500" onclick="window.location.href = '<?php echo site_url('My/setting'); ?>';">Edit</button></li>								
									</ul>
										...
										<div class="_htg452">
											...
											<div class="row">
												<div class="col-lg-3 col-md-4">
													<div class="fcrse_1 mt-30">
														<div class="tutor_img">
															<a href="#"><img src="images/default-icon.png" alt=""></a>												
														</div>
